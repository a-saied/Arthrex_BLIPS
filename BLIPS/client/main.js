...
var update_interval = 1000; //test value 
...
Template.display.onRendered(function(){
	...
	var second_radius = 400;
	var third_radius = 250; 
	var fourth_radius = 600;
	var first = draw.circle(first_radius*2).cx(125).cy(100).opacity('0.5').fill('#485167');
	var second = draw.circle(first_radius*2).cx(725).cy(100).opacity('0.5').fill('#485167');
	var third = draw.circle(first_radius*2).cx(725).cy(700).opacity('0.5').fill('#485167');
